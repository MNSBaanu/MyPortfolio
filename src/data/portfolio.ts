...
export const projects = [
  ...
  {
    title: 'AromaCafe POS',
    description: 'A desktop Point of Sale application for café operations. Features a product catalog with stock management, cart and checkout with change calculation, and sales history with itemized receipts. Runs fully offline with no server dependency.',
    tech: ['Electron', 'React', 'SQLite', 'Tailwind CSS', 'Vite'],
    period: '2025',
    academic: false,
    badge: 'Personal',
    images: [
  ...
  },
  {
    ...
    description: 'A full-stack fitness center management web app with user registration, class booking, trainer profiles, and role-based dashboards for customers, staff, and admins.',
    tech: ['HTML5', 'CSS3', 'JavaScript', 'PHP', 'MySQL'],
    period: '2025',
    academic: false,
    badge: 'Personal',
    ...
    liveUrl: '#',
    githubUrl: 'https://github.com/MNSBaanu/FitZone-Fitness-Center',
  },
  {
    title: 'LocalGro',
    description: 'A supply chain and warehouse management system for Sri Lanka\'s jackfruit processing industry. Handles inventory, orders, delivery tracking, and invoicing with role-based access for admins, warehouse managers, delivery staff, finance staff, and customers.',
  ...
  {
    title: 'WeatherApp',
    description: 'A PHP weather application with both a CLI and responsive web interface. Fetches real-time weather data via OpenWeatherMap API and includes a demo mode that works without an API key.',
    tech: ['PHP', 'HTML5', 'CSS3', 'OpenWeatherMap API'],
    period: '2025',
    academic: false,
    badge: 'Personal',
    images: [
  ...
  {
    title: 'SmartBee',
    description: 'A cross-platform campus life management platform for students. Features module tracking, attendance monitoring, a daily planner, and an AI-powered virtual assistant. Available on both web and mobile.',
    tech: ['React', 'React Native', 'Expo', 'Node.js', 'Supabase'],
    period: '2025 - Present',
    academic: false,
    badge: 'Personal',
    images: [
  ...
  {
    title: 'My Portfolio',
    description: 'A personal portfolio website showcasing projects, skills, education and experience. Built with modern web technologies featuring smooth animations, dark mode, and a responsive design.',
