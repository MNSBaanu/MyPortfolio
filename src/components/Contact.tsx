              ...
              <div className="bg-white border border-gray-300 rounded-lg shadow-lg max-w-md mx-auto">
                ...
                <div className="flex items-center p-4 border-t border-gray-300">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="ml-3 px-6 py-2.5 bg-gradient-to-r from-[#103257] to-[#0d4a6b] text-white text-sm font-semibold rounded-lg cursor-pointer border-none outline-none transition-all duration-300 hover:shadow-xl hover:from-[#0d2a47] hover:to-[#103257] disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
