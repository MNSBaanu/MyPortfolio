    ...
    <section id="projects" className="pt-4 sm:pt-6 md:pt-8 pb-12 sm:pb-16 md:pb-20 pl-6 sm:pl-8 md:pl-12 lg:pl-16 xl:pl-20 pr-16 sm:pr-20 md:pr-24 lg:pr-28 xl:pr-32 bg-white">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 sm:mb-10 md:mb-12 text-center text-black">Projects</h2>
                  ...
                  <div className="relative h-52 sm:h-64 md:h-72 bg-gray-100 overflow-hidden group/image">
                    <AnimatePresence mode="wait">
                      <motion.img
                        ...
                        onError={(e) => {
                          e.currentTarget.src = `https://placehold.co/600x400/000000/ffffff?text=${encodeURIComponent(project.title)}`
                        }}
                      />
                    </AnimatePresence>
                        ...
                        <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1.5 z-10">
                          {project.images.map((_, imgIndex) => (
                            <button
                              ...
                              className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${(imageIndices[project.title] || 0) === imgIndex
                                  ? 'bg-black w-4'
