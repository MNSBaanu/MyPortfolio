...
export default function About() {
  return (
    <div
      className="box-border min-h-[100svh] md:h-[100svh] pb-20 md:pb-0 px-6 sm:px-8 bg-slate-100 dark:bg-neutral-900 relative rounded-t-[3rem] sm:rounded-t-[4rem] border-t border-gray-200/50 dark:border-neutral-800 shadow-[0_-10px_50px_rgba(0,0,0,0.08)]"
      style={{
      ...
      <div className="h-full max-w-3xl mx-auto flex flex-col min-h-0 overflow-y-auto">
        ...
        <div className="flex flex-col items-center text-center pb-4">
          ...
          <motion.div
            ...
            className="w-full"
          >
            <h3 className="text-xs font-black text-gray-500 dark:text-gray-400 uppercase tracking-[0.3em] mb-3 sm:mb-4">
              Core Identity
            </h3>
            <div className="flex flex-wrap justify-center gap-2">
              {about.identityTags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl bg-white dark:bg-black border border-gray-200 dark:border-neutral-800 shadow-sm text-gray-700 dark:text-gray-300 text-xs font-bold tracking-tight"
                >
                  {tag}
                </span>
              ))}
