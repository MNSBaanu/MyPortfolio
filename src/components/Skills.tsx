...
export default function Skills() {
  ...
  return (
    <div className="py-24 sm:py-32 bg-zinc-100 relative z-10 rounded-t-[3rem] sm:rounded-t-[4rem] shadow-[0_-30px_60px_rgba(0,0,0,0.15)] border-t border-gray-100 min-h-screen">
